...
class TestAugmentQueryWithHistory:
    ...
    # ------------------------------------------------------------------
    # Multiple GP messages — all are included in augmented query
    # ------------------------------------------------------------------
    def test_all_gp_messages_included_in_augmented_query(self):
        """When there are multiple GP turns, all are included (budget permitting)."""
        ctx = {
            "conversation_history": (
