...
class TestPatientContextNotPassedToRetrieval:
    ...
    def test_retrieve_chunks_advanced_does_not_accept_patient_context(self) -> None:
        """retrieve_chunks_advanced() must raise TypeError if patient_context is passed."""
        import inspect
    ...
    def test_retrieve_chunks_raises_on_unexpected_patient_context_kwarg(self) -> None:
        """Passing patient_context as a kwarg must raise TypeError at the call site."""
    ...
    def test_retrieve_chunks_advanced_raises_on_unexpected_patient_context_kwarg(
        self,
    ) -> None:
        """Passing patient_context as a kwarg to retrieve_chunks_advanced must raise."""
        from src.api.services import retrieve_chunks_advanced
