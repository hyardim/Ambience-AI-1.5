...
class TestGroundedPromptPatientContext:
    ...
    def test_patient_context_block_present(self):
        prompt = build_grounded_prompt("What treatment?", _CHUNKS, patient_context=_FULL_CONTEXT)
    ...
    def test_partial_context_age_only(self):
        prompt = build_grounded_prompt("What treatment?", _CHUNKS, patient_context={"age": 72})
        assert "PATIENT CONTEXT" in prompt
