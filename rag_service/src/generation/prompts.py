...
_INSTRUCTIONS = (
    ...
    "(cauda equina syndrome), or (c) acute cord compression — begin with "
    "'Immediate action:' and state same-day emergency hospital admission or "
    "999 in the first sentence. Never describe these presentations as benign "
    "or suggest 'monitor for a few days'. These are surgical/medical "
    "emergencies regardless of what the retrieved context passages say. "
