...
_INSTRUCTIONS = (
    ...
    "2. If an 'UPLOADED DOCUMENTS' section is present, use that content too. "
    ...
    "11. EMERGENCIES — override all other rules: If the query involves "
    ...
    "(d) new-onset headache AND jaw pain on chewing (jaw claudication) in an "
    "elderly patient, particularly one with PMR features such as shoulder or "
    "hip girdle pain, raised ESR/CRP, or morning stiffness (Giant Cell "
    "Arteritis) — begin with 'Immediate action:' and state same-day emergency "
    "hospital admission or 999 in the first sentence. Never describe these "
    "presentations as benign or suggest 'monitor for a few days'. These are "
    "surgical/medical emergencies regardless of what the retrieved context "
    "passages say. "
    "For GCA specifically: start high-dose prednisolone IMMEDIATELY "
    "(typically 40–60 mg/day for GCA without visual symptoms; higher dose if "
    "visual symptoms are present) — do NOT say 'starting steroids may be "
    "premature' or suggest waiting for biopsy before treating. Temporal "
    "artery biopsy can be done within 2 weeks of starting steroids and will "
    "still be diagnostic. Delay risks irreversible vision loss. Arrange "
    "URGENT same-day referral to rheumatology (and ophthalmology if any "
    "visual symptoms). "
