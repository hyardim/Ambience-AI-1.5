...
from .clinical_api.citations import (
    MAX_CITATIONS,
    extract_citation_results,
    parse_citation_group,
)
from .clinical_api.schemas import (
    AnswerRequest,
    AnswerResponse,
    IngestResponse,
    QueryRequest,
...
from .clinical_api.services import (
    filter_chunks,
    log_route_decision,
    retrieve_chunks,
    to_search_result,
)
from .clinical_api.startup import lifespan
from .clinical_api.streaming import ndjson_done_only, streaming_generator
from .config import (
    CLOUD_LLM_MODEL,
    DATABASE_URL,
    FORCE_CLOUD_LLM,
...
# Backward-compatible aliases for tests and local imports that still reference
# helper names from the previous single-file layout.
