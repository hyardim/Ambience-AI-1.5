...
export function NHSLogo({ className = '' }: { className?: string }) {
  return (
    <Link to="/" className={`flex items-center ${className}`}>
      <div className="bg-[var(--nhs-blue)] px-3 py-1 rounded">
        <svg width="370.61" height="150" version="1.1" viewBox="0 0 370.61 150" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
            <rect width="370.61" height="150" fill="var(--nhs-blue)" strokeWidth="3.75"/>
