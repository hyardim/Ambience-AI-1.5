...
class TestLogin:
    ...
    def test_login_returns_correct_role(
        self, client, specialist_user_payload, registered_specialist
    ):
        resp = client.post(
            "/auth/login",
            data={
...
class TestMe:
    ...
    def test_me_specialist_returns_correct_data(
        self, client, specialist_user_payload, specialist_headers
    ):
